...
star_wars1 = media.Movie("Star Wars Episode I: The Phantom Menace",
                         ...
                         """Two Jedi Knights escape a hostile blockade to
                          find allies and come across a young boy who may
                          bring balance to the Force, but the long dormant
                          Sith resurface to reclaim their old glory.""",
...
star_wars2 = media.Movie("Star Wars Episode II: Attack of the Clones",
                         ...
                         while Obi-Wan investigates an assassination attempt
                         on the Senator and discovers a secret clone army 
...
star_wars3 = media.Movie("Star Wars Episode III: Revenge of the Sith",
                         ...
                         Darth Sidious has revealed himself and is
                         ready to execute the last part of his plan to 
                         rule the Galaxy.""",
...
star_wars5 = media.Movie("Star Wars Episode V: The Empire Strikes Back",
                         ...
                         Luke Skywalker takes advanced Jedi training with
                         Master Yoda, while his friends are pursued by
...
star_wars6 = media.Movie("Star Wars Episode 6: The Return of the Jedi",
                         ...
                         Jabba the Hutt, the rebels attempt to destroy 
                         the second Death Star, while Luke struggles to
                         make Vader return from the dark side of the Force.""",
